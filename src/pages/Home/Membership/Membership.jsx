...
const Membership = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-24 mb-24 p-3">
      <div className="card card-compact border">
        ...
        <div className="card-body">
          <ul className="h-28">
            ...
            <li className="text-base flex items-center">
              <BsCheckLg className="text-red-600"></BsCheckLg>Standard bed type
            </li>
            <li className="text-base flex items-center">
